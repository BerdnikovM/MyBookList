            ...
            if ($stmt->num_rows > 0) {
                ...
                if (password_verify($password, $passwordHash)) {
                    ...
                    if ($is_admin) {
                        ...
                        // Устанавливаем куку для администратора
                        setcookie('is_admin', true, time() + (86400 * 30), "/"); // кука действительна 30 дней
                    }
                    // Устанавливаем куку аутентификации
                    setcookie('authenticated', true, time() + (86400 * 30), "/"); // кука действительна 30 дней
